...
const command: CommandInterface = {
    ...
    execute: async (interaction: Discord.ChatInputCommandInteraction) => {
        ...
        const rarityOrder = [Rarity.CHARR, Rarity.DEAD, Rarity.DEPTH, Rarity.LEMON, Rarity.QUEEN, Rarity.GOD, Rarity.SSS, Rarity.SS, Rarity.S, Rarity.A, Rarity.B, Rarity.C, Rarity.D];
